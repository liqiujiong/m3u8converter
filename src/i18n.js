...
const translations = {
    zh: {
        ...
        blog_latest: '🆕 最新文章',
        blog_guides: '📖 基础教程',
        blog_new_no_links: 'No M3U8 Links Found 修复指南：6步定位并恢复下载',
        blog_new_merger: 'M3U8 Merger 工具指南：3种方法合并TS到MP4',
        blog_new_encrypted: 'Download HLS Encrypted Video：合规场景、限制与实操',
        blog_new1: '在线 M3U8 下载器：浏览器转 MP4 实战指南',
        blog_new2: 'M3U8 与 MP4 有什么区别？',
        blog_new3: 'FFmpeg 下载 M3U8 命令指南',
        blog_new_mp4: 'MP4转M3U8：HLS流媒体制作教程',
        blog_new_m3u8_link: '在线获取M3U8链接：6种方法',
        blog_new_downloadhelper: 'Video DownloadHelper 抓 M3U8 实战指南',
        blog_new_m3u8_download: 'M3U8 Download 完整指南：4 种方法下载',
    ...
    en: {
        ...
        blog_new_no_links: 'No M3U8 Links Found Fix Guide: 6 Steps to Recover',
        blog_new_merger: 'M3U8 Merger Tool Guide: 3 Ways to Merge TS to MP4',
        blog_new_encrypted: 'Download HLS Encrypted Video: Legal Scenarios, Limits, and Methods',
        ...
        blog_new_mp4: 'MP4 to M3U8: HLS Streaming Guide',
        blog_new_m3u8_link: 'Get M3U8 Link from URL: 6 Methods',
        blog_new_downloadhelper: 'Video DownloadHelper for M3U8: Complete Guide',
        blog_new_m3u8_download: 'M3U8 Download Guide: 4 Reliable Ways',
